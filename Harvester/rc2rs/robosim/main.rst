...
interface I_inact_clone_deadlineAction_normal_AppleHarvestControl_LocalizeFruit_Solving_t2_op_t_i_f {
	var inact_clone_deadlineAction_normal_AppleHarvestControl_LocalizeFruit_Solving_t2_op_t_i_f : boolean = false
}
...
interface I_inact_clone_deadlineAction_normal_AppleHarvestControl_GetApple_entry_t_i_f {
	var inact_clone_deadlineAction_normal_AppleHarvestControl_GetApple_entry_t_i_f : boolean = false
}
...
interface I_inact_clone_deadlineAction_normal_AppleHarvestControl_LocalizeFruit_Start_t1_op_t_i_f {
	var inact_clone_deadlineAction_normal_AppleHarvestControl_LocalizeFruit_Start_t1_op_t_i_f : boolean = false
}
